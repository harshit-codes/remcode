...
interface DependencyAnalysis {
  ...
  files: Record<string, {
    dependencies: string[];
    dependents: string[];
    imports: Record<string, string[]>; // Module -> imported symbols
    exports: string[];
    is_entry_point: boolean;
  }>;
  key_files: string[];
  dependency_graph: {
    nodes: Array<{id: string; type: 'file' | 'module'; is_core?: boolean; is_entry_point?: boolean}>;
    edges: Array<{source: string; target: string; type: 'imports' | 'exports' | 'uses'}>;
  };
}
